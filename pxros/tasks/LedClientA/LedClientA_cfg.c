...
extern void LedClientA_taskFunc(PxTask_t myID, PxMbx_t myMailbox, PxEvents_t myActivationEvents);
...
PxTask_t LedClientA_Create(PxPrio_t prio, PxEvents_t events, PxMc_t memClass, PxOpool_t objPool)
{
    ...
    /* Configure Task spec */
    task_Spec.ts_name                       = (const PxChar_t *)"Task LedClientA";
    task_Spec.ts_fun                        = LedClientA_taskFunc;
